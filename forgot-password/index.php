...
$mail->Username   = "hugwithmugco@gmail.com";
$mail->Password   = "UTSA2022se!";
	$mail->IsHTML(true);
$mail->AddAddress("kassiejgarcia@gmail.com", "recipient-name");
$mail->SetFrom("hugwithmugco@gmail.com", "from-name");
