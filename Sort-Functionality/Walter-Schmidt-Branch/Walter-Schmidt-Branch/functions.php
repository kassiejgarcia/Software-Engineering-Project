...
$db = mysqli_connect("localhost","root","","softwareengineeringproject");
...
} else if (isset($_POST['quantity_asc']))
{

$get_products = "select * from products order by product_quantity ASC";

} else if (isset($_POST['quantity_desc']))
{

$get_products = "select * from products order by product_quantity DESC";
